...
def start():
            ...
            for engineitem in engines:
                if engineitem == 'baidu':
                    ...
                    try:
                        ...
                        print(f'[An error occurred with Dogpile: {e} ')
    ...
    if shodan is True:
        ...
        try:
            ...
            print(f'[93m[!] An error occurred with Shodan: {e} ')
    else:
        pass
    ...
    if filename != "":
        ...
        try:
            ...
            print(f'[93m[!] An error occurred while saving the XML file: {er} ')
        print('\n\n')
        sys.exit(0)
...
if __name__ == '__main__':
    if python_version()[0:3] < '3.6':
        print('[93m[!] Make sure you have Python 3.6+ installed, quitting.\n\n ')
        sys.exit(1)
    try:
        start()
